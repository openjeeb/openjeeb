...
$files = $this->trace(array('start' => 3, 'format' => 'points'));
$listing = (is_array($files[0]) && isset($files[0]['file'], $files[0]['line']))
    ? $this->excerpt($files[0]['file'], $files[0]['line'] - 1, 1)
    : array();
$trace = $this->trace(array('start' => 3, 'depth' => '20'));
