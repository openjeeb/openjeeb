<div class="col-xs-16 col-md-4">
    <div class="box">
        ...
        <div class="block" id="shortlinks">
            <ul class="menu">
                <li><?php echo $this->Html->link('Income Sub Types', array('action' => 'index')); ?></li>
...
<div class="col-xs-16 col-md-12">
    <div class="box">
            <div class="incomeSubTypes view">
            <h2>Income Sub Type</h2>
                    <div class="block">
                            <dl><?php $i = 0; $class = ' class="altrow"';?>
                                    		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $incomeSubType['IncomeSubType']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $incomeSubType['IncomeSubType']['name']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Income Type'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $incomeSubType['IncomeSubType']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $incomeSubType['IncomeSubType']['modified']; ?>
			&nbsp;
		</dd>
                            </dl>
                    </div>
