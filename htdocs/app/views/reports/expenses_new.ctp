    ...
    <div class="col-xs-16 col-md-16">
        <div class="box rounded">
            ...
            <div id="filter" class="form">
                <?php echo $this->Form->create('Expense',array('url'=>array('controller'=>'reports','action'=>'expenses_new'))); ?>
                <fieldset>
                    <div class="input text" style="position: relative;">
                        <label for="ExpenseExpenseCategoryId">نوع هزینه</label>
                        <?php echo $this->Form->text('Expense.category_id',array('value'=>'','autocomplete'=>'off')); ?>
    ...
    <div class="col-xs-16 col-md-16">
        <div class="table-responsive"><table class="table table-striped table-hover table-bordered"  id="dataTable" cellpadding="0" cellspacing="0">
                <thead class="table-primary" >
                    <tr>
                        <th>نوع هزینه</th>
                        <th><?php echo $this->Html->link('مجموع هزینه', array('categorysort'=>(@$this->passedArgs['categorysort']!='asc')? 'asc' : 'desc'), array('class'=>@$this->passedArgs['categorysort'])) ?></th>
