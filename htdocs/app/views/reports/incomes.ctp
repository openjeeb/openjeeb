    ...
    <div class="col-xs-16 col-md-16">
        <div class="rounded box">
            ...
            <div id="filter" class="form">
                <?php echo $this->Form->create('Income',array('url'=>array('controller'=>'reports','action'=>'incomes'))); ?>
                <fieldset>
                    <?php
                    echo $this->Form->input('Income.search',array('type'=>'hidden','value'=>true));
                    echo $this->Form->input('Income.income_type_id',array('label'=>'نوع درآمد','type'=>'select','options'=>$incomeTypes,'empty'=>true));
...
<div class="row ">
    <div class="col-xs-16 col-md-16" style="text-align: center;margin-right: 0px;">
...
<div class="row">
    <div class="col-xs-16 col-md-4">
        <h2 id="page-heading">لیست درآمدها  <?php echo $this->Html->link('<i class="fa fa-file-excel-o"></i>',array('export'),array('escape' => false,'id'=>'excelExport')); ?></h2>
    </div>
